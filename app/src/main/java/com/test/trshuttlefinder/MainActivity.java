...
public class MainActivity extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        String dbFrom[] = dbString.split(System.getProperty("line.separator"));
        dbString = dbHandler.databaseToString(3);
        String dbTo[] = dbString.split(System.getProperty("line.separator"));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int i, long l) {
        ...
        else if (spinner.getSelectedItemPosition()!=0 && spinner.getSelectedItemPosition()!=2 ){
            spinner2.setSelection(2);
        }
        else if (spinner2.getSelectedItemPosition()!=0 && spinner.getSelectedItemPosition()!=2 ){
            spinner.setSelection(2);
        }
        else if (spinner2.getSelectedItemPosition()==2 && spinner.getSelectedItemPosition()==2 ){
            spinner2.setSelection(0);
        }
